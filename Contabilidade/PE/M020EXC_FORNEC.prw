...
M020EXC - Complementa validações de exclusão de fornecedor (07/10/2020)
  O ponto de entrada M020EXC complementa as validações do sistema sobre a exclusão de registros
   do cadastro de fornecedores (Tabela SA2) com validações de usuário.
                    ...
                    LOCALIZAÇÃO : Função fAvalSA2() - Complementa a atualização da tabela de 
					fornecedores.

                    EM QUE PONTO : Após as validações do sistema para a exclusão do registro do
					 Fornecedor. Deve ser utilizado para realizar validações de usuário, complementando 
					 as validações do sistema.
*/
