...
//	PutMv("MV_NUMLIN",99999)
	...
	While !FT_FEOF()
		...
		Replace TRP->CCD   With SubStr(cTexto,54,20)
		Replace TRP->CCC   With SubStr(cTexto,63,20)
		Replace TRP->ICD   With SubStr(cTexto,72,20)
		Replace TRP->ICC   With SubStr(cTexto,81,20)
