...
/*
	...
	lQuery		:= .T.
		...
		NLIN +=  15 	
		OREPORT:SAY( NLIN-1, ((NMEIO+NMAXWIDTH)/2)-50, "DESCONTO:", OFONT1:OFONT )
		OREPORT:SAY( NLIN-1, ((NMEIO+NMAXWIDTH)/2)+68, TRANSFORM(TRBFAT->F2_DESCONT,"@E 9,999,999,999.99"), OFONT2:OFONT ) // Rossana 
		NLIN +=  15 	// 550
		...
		nValorf := TRBFAT->F2_VALBRUT -TRBFAT->F2_DESCONT - TRBFAT->F2_VALIRRF //desconto 0505
